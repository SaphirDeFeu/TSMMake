...
main: src/**
	...
	$(CXX) $(CXXFLAGS) -o target/tsmmake target/obj/main.o target/obj/new.o target/obj/build/mod.o target/obj/build/run.o target/obj/help.o target/obj/parser/mod.o
